...
class Smarty_Internal_Compile_Extends extends Smarty_Internal_Compile_Shared_Inheritance {
	...
	private function compileEndChild(Smarty_Internal_TemplateCompilerBase $compiler) {
		$compiler->parser->template_postfix [] = new Smarty_Internal_ParseTree_Tag ( $compiler->parser, "<?php \$_smarty_tpl->ext->_inheritance->endChild(\$_smarty_tpl);\n?>\n" );
	}
	...
	private function compileInclude(Smarty_Internal_TemplateCompilerBase $compiler, $file) {
		$compiler->parser->template_postfix [] = new Smarty_Internal_ParseTree_Tag ( $compiler->parser, $compiler->compileTag ( 'include', array (
				$file,
				array (
						'scope' => 'parent' 
				) 
