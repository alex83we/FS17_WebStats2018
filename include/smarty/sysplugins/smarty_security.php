...
class Smarty_Security {
	...
	public function isTrustedResourceDir($filepath, $isConfig = null) {
		...
		if ($isConfig !== true && (! isset ( $this->smarty->_cache ['template_dir_new'] ) || $this->smarty->_cache ['template_dir_new'])) {
		...
		if ($isConfig !== false && (! isset ( $this->smarty->_cache ['config_dir_new'] ) || $this->smarty->_cache ['config_dir_new'])) {
