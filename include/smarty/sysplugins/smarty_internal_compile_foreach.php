...
class Smarty_Internal_Compile_Foreach extends Smarty_Internal_Compile_Private_ForeachSection {
	...
	public function compile($args, Smarty_Internal_TemplateCompilerBase $compiler, $parameter) {
		...
		$local = '$__foreach_' . (isset ( $attributes ['name'] ) ? $attributes ['name'] : $attributes ['item']) . '_' . $this->counter ++ . '_';
		$needIteration = false;
		...
		foreach ( array (
			...
			if (isset ( $attributes [$a] )) {
				$saveVars ['saved_' . $a] = "isset(\$_smarty_tpl->tpl_vars['{$attributes[$a]}']) ? \$_smarty_tpl->tpl_vars['{$attributes[$a]}'] : false;";
...
class Smarty_Internal_Compile_Foreachelse extends Smarty_Internal_CompileBase {
	...
	public function compile($args, Smarty_Internal_TemplateCompilerBase $compiler, $parameter) {
		...
		list ( $openTag, $nocache, $local, $restoreVars, $itemVar, $foo ) = $this->closeTag ( $compiler, array (
				'foreach' 
		) );
...
class Smarty_Internal_Compile_Foreachclose extends Smarty_Internal_CompileBase {
	...
	public function compile($args, Smarty_Internal_TemplateCompilerBase $compiler, $parameter) {
		...
		list ( $openTag, $compiler->nocache, $local, $restoreVars, $itemVar, $restore ) = $this->closeTag ( $compiler, array (
				'foreach',
				'foreachelse' 
		) );
		$output = "<?php\n";
